...
export default class HtmlLocalSrcPlugin extends Plugin {
  async onload() {
    ...
    this.registerMarkdownPostProcessor((element, ctx) => {
      ...
      console.log("ActiveFile", active_file.basename);

      let targetLinks = [];
      Array.from(element.getElementsByTagName("img")).forEach(function (link) {
        // console.log("Original Link" + link.src)
        // console.log(link.src.contains(active_file.basename))
      ...
      console.log('BASE active_file_path: ' + active_path)
